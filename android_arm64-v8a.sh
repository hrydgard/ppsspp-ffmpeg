...
./configure --logfile=conflog.txt --target-os=linux \
    ...
    ${GENERAL} \
    --sysroot=$NDK/sysroot \
    --extra-cflags="$EXTRA_CC --target=aarch64-none-linux-android21 -no-canonical-prefixes -fdata-sections -ffunction-sections -fno-limit-debug-info -funwind-tables -g -O0 -DANDROID -DANDROID_PLATFORM=$BUILD_ANDROID_PLATFORM -Dipv6mr_interface=ipv6mr_ifindex -fasm -fno-short-enums -fno-strict-aliasing" \
    --disable-shared \
    --enable-static \
